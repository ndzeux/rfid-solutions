...
<footer>
    <div class="botnav row">
        <div class="contact">
            ...
            <div class="row middle-xs">
                <svg style="width:18px;height:18px;margin-right: 4px" viewBox="0 0 24 24">
    ...
    <div class="botmenu row center-xs">
        <a href="/products" use:link>Products</a>
        <a href="/solutions" use:link>Solutions</a>
        <a href="/services" use:link>Services</a>
        <a href="/industries" use:link>Industries</a>
        <a href="/case-studies" use:link>Case Studies</a>
    </div>
    <div class="copyright">
        &copy Copyright {new Date().getFullYear()} <a href="/" use:link>RFIDSOlutions.id</a><span>【Internet of Things - Cloud RFID System】</span>
    </div>
</footer>
...
<style>
    ...
    .botnav{
        padding: 32px calc((100vw - 1360px) / 2);
        margin: 0
    }
    .botnav > div{
        padding: 0 16px
